...
import me.planetguy.endgamerf.mbmachines.tileentities.TileEntityVaporizedItemPort;
...
public class BlockMachinePort extends BlockContainerBase{
	...
	public BlockMachinePort() {
		super(Material.iron, "mbMachinePort", 
				TileEntityEnergyInputPort.class, 
				TileEntityVaporizedItemPort.class);
	}
